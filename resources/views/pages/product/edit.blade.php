    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-4">
                <form action="{{ route('master.produk.update',$product->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('merek') is-invalid @enderror" id="merek" name="merek" value="{{ old('merek', $product->merek) }}">
                            @error('merek')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('min_stock') is-invalid @enderror" id="min_stock" name="min_stock" value="{{ old('min_stock', $product->name) }}">
                            @error('min_stock')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('min_stock', $product->price) }}">
                            @error('price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
